                            ...
                            <div class="flex-auto p-6">
                                ...
                                <div class="flex">
                                    ...
                                    <div class="w-fit my-2 mx-3">
                                        ...
                                        <select id="unidades"
                                            class="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline hover:cursor-pointer">
