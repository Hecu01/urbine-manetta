    ...
    <div class="informacion-footer flex justify-between w-100" style="position: relative">
        ...
        <div class="redes-sociales " style="width: 300px">
            ...
            <ul class="" style="width: 300px">
                ...
                <li ><a class="text-white"href=""><i class="fa-brands fa-square-facebook"></i> - Tienda deportiva Sportivo Online</a></li>
                <li ><a class="text-white" style="align-items: flex-start" href=""><i class="fa-brands fa-square-whatsapp"></i> - Atención al cliente (3364036241)</a></li>
            </ul>
        </div>
        ...
        <span class="bg-slate-500 mx-2 px-2 py-1 text-lg" style="position: absolute;bottom:-15px;right: 0px">Sportivo 2022 &copy; todos los derechos reservados</span>
    </div>
</footer>