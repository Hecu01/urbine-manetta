        ...
        <div class="left flex">
            ...
            @else
                ...
                <div class="usuario-logueado items-center">
                    ...
                    <!-- Usuario -->
                    <div class="w-32 mr-3">
                        <img src="{{ asset('assets/img/sportivo-logo.svg') }}" alt="Logo"
                ...
                <ul class="dropdown-menu w-96 h-96 overflow-y-auto">
                    @if ($contarItems > 0)
                        ...
                        @foreach ($cartItems as $item)
                            ...
                            <hr>
                        @endforeach
                        <a href="http://127.0.0.1:8000/carrito-de-compras#"
                            class="no-underline text-black hover:bg-slate-200 p-1 px-3 rounded text-lg"
                            style=" display: block; width: 100%; text-align: center;">Entrar al carrito</a>
                    @else
