    ...
    <section class="center-actions " style="max-width: 800px">
        ...
        <div class="">
                                ...
                                @if ($estado == 'Pendiente')
                                    <form action="{{ route('articulos.aceptar', $id) }}" method="POST" class="d-inline"
                                        ...
                                        <input type="number" name="unidades_aceptadas" placeholder="Cantidad" required
                                            min="0" max="{{ $stock }}" class="form-control"
                                            style="width: 100px; display: inline-block" oninput="validar(this)">
            ...
            @if ($reposicionesPendientes === 0)
                <h2 class="text-blue-500 text-center">Vaya vaya... parece que no hay <br>pedidos de reposicion pendientes...
                </h2>
