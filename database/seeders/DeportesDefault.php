...
class DeportesDefault extends Seeder
{
    ...
    public function run(): void
    {
        $deportes = [
            ...
            ['deporte' => 'Otro deporte', 'categoria_deporte' => 'Deportes de gimnasio, campo, cerrados'],
            ['deporte' => 'Gym', 'categoria_deporte' => 'Deportes de gimnasio'],
            ['deporte' => 'Crossfit', 'categoria_deporte' => 'Deportes de gimnasio'],
